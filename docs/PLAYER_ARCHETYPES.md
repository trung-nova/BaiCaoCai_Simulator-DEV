...
- **Chiến thuật:** Nit ưu tiên bảo toàn vốn. Nó thường dừng lại sớm khi cảm thấy an toàn, ít khi mạo hiểm trừ khi bài quá xấu.
...
### 2.4. NORMAL (Bình thường) - Người chơi thực tế
- **Kỹ năng (`skill`):** 0.35 - 0.65 (Trung bình).
- **Độ tự tin (`mean_confidence`):** 0.0 (Trung dung).
...
- **Sự dịch chuyển tài sản**: Tiền thường có xu hướng chảy từ Maniac và Fish sang Nit và Shark.
