...
*   **Trả lời:** 
    *   **Trò chơi có Tổng âm (Negative-Sum Game):** Kết quả Win Rate hội tụ về $\approx 42\%$ chứng minh lợi thế toán học tuyệt đối của Nhà cái (House Edge). Chiến thuật tối ưu không phải là thắng đậm mà là quản trị rủi ro để tồn tại lâu nhất.
