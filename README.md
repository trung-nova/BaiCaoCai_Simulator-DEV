...
*   [**Từ điển Dữ liệu (Data Dictionary)**](./docs/DATA_DICTIONARY.md): Định nghĩa chi tiết các trường thông tin trong SQLite và CSV.
*   [**Phân loại AI (Archetypes)**](./docs/PLAYER_ARCHETYPES.md): Giải thích các nhóm nhân vật (Shark, Maniac, Nit).

### 🎓 Học thuật & Bảo vệ
*   [**Luật chơi (Game Rules)**](./docs/GAME_RULES.md): Quy tắc tính điểm và lợi thế nhà cái (House Edge).
*   [**Bộ câu hỏi phản biện (Q&A)**](./docs/LECTURER_Q&A_PREPARATION.md): Chuẩn bị cho các câu hỏi từ giảng viên về kiến trúc và thuật toán.
...
```text
.
├── docs/               # Hệ thống tài liệu học thuật chi tiết (.md)
...
└── README.md           # Hướng dẫn nhanh và portal tài liệu
```
...
3.  **Kiểm thử**: Chạy `.\build_tests.bat` để xác minh độ chính xác của logic toán học và tích hợp hệ thống.
