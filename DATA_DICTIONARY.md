...
| `swapped` | BOOLEAN (0/1) | Kết quả cuối cùng: `1` là đã đổi, `0` là giữ nguyên. |
...
Dùng cho việc xử lý nhanh bằng thư viện Pandas hoặc Excel.

### 2.1. `*_bankroll_history.csv`
Theo dõi biến động tài sản theo thời gian.

- **Cấu trúc**: `Round, Player1_Balance, Player2_Balance, ...`
...
- **Cấu trúc**: `Round, Player, Turn, Satisfaction, Desire, Probability, Result, ScoreBefore, ScoreAfter, CardOut, CardIn`
